...
#names_scores = ((grades['name']) & (grades['score']))

print(grades.iloc[[1,3,5,6],[0]])
...
print(grades[grades['attempts'] > 2])
...
print(grades[grades['score'].between(15,20)])
...
grades = grades.sort_values(['attempts', 'name'], ascending=[True, True])
